...
if uploaded_file is not None:
    ...
    if st.button("ম্যাজিক শুরু করুন ✨"):
        with st.spinner('একটু অপেক্ষা করুন, সোলাইমান ভাই! AI আপনার ভিডিও প্রসেস করছে...'):
            ...
            st.info(f"নমস্কার বন্ধুরা, আজকের ভিডিওতে আমরা বিস্তারিত আলোচনা করেছি {text[:150]} নিয়ে। #SolaimanSEO")
            ...
            st.code("সোলাইমান ট্রান্সক্রিপ্ট, ভিডিও এসইও টুল, বাংলা ভিডিও অটোমেশন, YouTube SEO")
